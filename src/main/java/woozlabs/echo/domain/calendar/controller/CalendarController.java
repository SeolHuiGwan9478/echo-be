...
public class CalendarController {
    ...
    public ResponseEntity<?> getCalendars(HttpServletRequest httpServletRequest, @RequestParam("aAUid") String aAUid){
    ...
    public ResponseEntity<?> getUnavailableEvents(HttpServletRequest httpServletRequest, @RequestParam("aAUid") String aAUid) {
